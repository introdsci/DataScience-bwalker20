...
In this stage of the project, we go over changes we made to the previous phases. We also talk about the results from the cross validation and what they mean. Then we talk about how we can operationalize the models that we created and also go over the implications of these models.  
https://introdsci.github.io/DataScience-bwalker20/Results_and_Operationalization.html